    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                ><img src="image/logo.PNG" style="margin-bottom: 5px;" width="30">   SISTEM ABSENSI BERBASIS WEBSITE</a>
            </div>
            <!-- /.navbar-header -->
...
<?php if($level=='user'){ ?>
                        <li>
                            <a href="media.php?module=Gallery"><i class="fa fa-dashboard fa-fw"></i> Gallery</a>
                        </li>
<?php } ?>
