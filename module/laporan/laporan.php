                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php while($k<=$tp){ 
                               ...
                               ?>
                               <tr>
                                <td colspan="32" class="text-center info"><?php echo $tanggal  ?></td>
                            </tr>
                            <tr>
                                <td class="success text-center" rowspan="1">Tanggal</td>
                            ...
                            while($yu<=$jml){ 
                                ...
                                <tr>
                                    ...
                                    while($yu<=$jml){ 
                                        ...
                                        $sqla=mysql_query("select * from absen where ids='$ids' and tgl='$tanggul'");
